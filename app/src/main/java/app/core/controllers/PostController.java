...
/**
 * The Class PostController handles Thread logic. The user can comment, answer,
 * and like threads by use of the command line. Upon entering the Thread, the
 * current user will be registered in the database's UserView-table.
 */
public class PostController extends AbstractController {
	...
	/**
	 * Post a comment/answer in the current Thread. Whether a comment or answer is
	 * posted is based on the entered command. An answer will either be added as an
	 * 'instructors answer' or 'students answer' based on the role-properties of the
	 * current user.
	 * 
	 * @see User
	 * @see Post
