...
/**
 * The Class LoginController handles User login. Reads username and password from user input and
 * verifies the user by looking up the column where username and password matches in the database.
 */
  ...
  public boolean readInput() {
    ...
    try {
      ...
      if (user != null) {
        ...
        System.out.println(String.format("You are logged in as: %s", user.getEmail()));
        return true;
      }
