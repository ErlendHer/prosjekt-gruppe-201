...
/**
 * The Class Post represents a Post-object fetched from the Database.
 */
public class Post extends AbstractModel {
  ...
  public String toString() {
    return "Post [postID=" + this.getId() + ", threadID=" + threadID + ", userID=" + userID
        + ", parentID=" + parentID + ", content=" + content + ", isAnswer=" + isAnswer
        + ", datePosted=" + datePosted + ", lastUpdated=" + lastUpdated + "]";
  }
