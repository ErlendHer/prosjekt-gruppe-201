...
/**
 * The Class User represents a User-object fetched from the Database. A User can be registered as
...
public class User extends AbstractModel {
   ...
   */
  public User(String email, String firstName, String lastName, boolean isStudent,
  ...
  public String toString() {
    return "User [userID=" + this.getId() + ", email=" + email + ", firstName=" + firstName
        + ", lastName=" + lastName + ", isStudent=" + isStudent + ", isInstructor=" + isInstructor
        + "]";
  }
